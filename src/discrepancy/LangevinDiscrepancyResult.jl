# The returned result from a langevin discrepancy

type LangevinDiscrepancyResult
    ...
    LangevinDiscrepancyResult(points,weights,edges,objectivevalue,g,gradg,
                              operatorg,edgetime,solvetime) = (
